...
extern "C" {
::std::int32_t CXXBRIDGE_SYMBOL(IConsole_IResult$GetInteger)(::IConsole_IResult const &self, ::std::uint32_t Index) noexcept
{
	::std::int32_t (::IConsole_IResult::*GetInteger$)(::std::uint32_t) const = &::IConsole_IResult::GetInteger;
	return (self.*GetInteger$)(Index);
}

float CXXBRIDGE_SYMBOL(IConsole_IResult$GetFloat)(::IConsole_IResult const &self, ::std::uint32_t Index) noexcept
{
	float (::IConsole_IResult::*GetFloat$)(::std::uint32_t) const = &::IConsole_IResult::GetFloat;
	return (self.*GetFloat$)(Index);
}

void CXXBRIDGE_SYMBOL(IConsole_IResult$GetString)(::IConsole_IResult const &self, ::std::uint32_t Index, ::StrRef *return$) noexcept
{
	::StrRef (::IConsole_IResult::*GetString$)(::std::uint32_t) const = &::IConsole_IResult::GetString;
	new(return$)::StrRef((self.*GetString$)(Index));
}

void CXXBRIDGE_SYMBOL(IConsole_IResult$GetColor)(::IConsole_IResult const &self, ::std::uint32_t Index, float DarkestLighting, ::ColorHSLA *return$) noexcept
{
...
::std::int32_t CXXBRIDGE_SYMBOL(IConsole_IResult$NumArguments)(::IConsole_IResult const &self) noexcept
{
	::std::int32_t (::IConsole_IResult::*NumArguments$)() const = &::IConsole_IResult::NumArguments;
	return (self.*NumArguments$)();
}

::std::int32_t CXXBRIDGE_SYMBOL(IConsole_IResult$GetVictim)(::IConsole_IResult const &self) noexcept
{
	::std::int32_t (::IConsole_IResult::*GetVictim$)() const = &::IConsole_IResult::GetVictim;
	return (self.*GetVictim$)();
}

void CXXBRIDGE_SYMBOL(IConsole$ExecuteLine)(::IConsole &self, ::StrRef *pStr, ::std::int32_t ClientId, bool InterpretSemicolons) noexcept
{
...
void CXXBRIDGE_SYMBOL(IConsole$Print)(::IConsole const &self, ::std::int32_t Level, ::StrRef *pFrom, ::StrRef *pStr, ::ColorRGBA *PrintColor) noexcept
{
...
void CXXBRIDGE_SYMBOL(IConsole$Register)(::IConsole &self, ::StrRef *pName, ::StrRef *pParams, ::std::int32_t Flags, ::IConsole_FCommandCallback *pfnFunc, ::UserPtr *pUser, ::StrRef *pHelp) noexcept
{
...
::IConsole *CXXBRIDGE_SYMBOL(CreateConsole)(::std::int32_t FlagMask) noexcept
{
