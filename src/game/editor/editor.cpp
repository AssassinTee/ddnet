	...
	for(int y = 0; y < pTiles->m_Height; y++)
	{
		for(int x = 0; x < pTiles->m_Width; x++)
		{
			...
			else if(Index == ENTITY_ARMOR_1)
			{
				...
				Sprites()->GetSpriteScale(SPRITE_PICKUP_HEALTH, Scale.x, Scale.y);
				VisualSize = 64;
			}
			...
			else if(Index == ENTITY_WEAPON_SHOTGUN)
			{
				...
				Sprites()->GetSpriteScale(SPRITE_PICKUP_SHOTGUN, Scale.x, Scale.y);
			...
			else if(Index == ENTITY_WEAPON_GRENADE)
			{
				...
				Sprites()->GetSpriteScale(SPRITE_PICKUP_GRENADE, Scale.x, Scale.y);
			...
			else if(Index == ENTITY_WEAPON_LASER)
			{
				...
				Sprites()->GetSpriteScale(SPRITE_PICKUP_LASER, Scale.x, Scale.y);
			...
			else if(Index == ENTITY_POWERUP_NINJA)
			{
				...
				Sprites()->GetSpriteScale(SPRITE_PICKUP_NINJA, Scale.x, Scale.y);
				VisualSize = 128;
			}
...
void CEditor::Init()
{
	...
	m_Sprites.Init(m_pGraphics);
	m_RenderMap.Init(m_pGraphics, m_pTextRender, &m_Sprites);
