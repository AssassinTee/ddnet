...
void CRenderMap::Init(IGraphics *pGraphics, ITextRender *pTextRender, CSprites *pSprites)
{
...
void CRenderMap::CalcScreenParams(float Aspect, float Zoom, float *pWidth, float *pHeight)
{
...
void CRenderMap::MapScreenToWorld(float CenterX, float CenterY, float ParallaxX, float ParallaxY,
...
void CRenderMap::MapScreenToGroup(float CenterX, float CenterY, CMapItemGroup *pGroup, float Zoom)
{
...
void CRenderMap::MapScreenToInterface(float CenterX, float CenterY, float Zoom)
{
	float aPoints[4];
