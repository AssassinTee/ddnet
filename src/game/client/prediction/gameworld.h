...
public:
	...
	std::unordered_map<int, CEnvelopeTriggerState> &EnvelopeTriggerState() { return m_vEnvelopeTriggerstate; }
...
private:
	...
	std::unordered_map<int, CEnvelopeTriggerState> m_vEnvelopeTriggerstate;
