...
void CGameClient::OnReset()
{
	...
	m_Tuning[g_Config.m_ClDummy] = CTuneParams();
...
void CGameClient::OnNewSnapshot()
{
	...
	if(AnyRecording && mem_comp(&StandardTuning, &m_Tuning[g_Config.m_ClDummy], sizeof(CTuneParams)) != 0)
	{
