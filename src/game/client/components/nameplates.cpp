...
public:
	void Update(CGameClient &This, const CNamePlateData &Data) override
	{
		...
		if(Data.m_InGame)
		{
			...
			This.RenderMap()->MapScreenToInterface(This.m_Camera.m_Center.x, This.m_Camera.m_Center.y);
...
public:
	void Render(CGameClient &This, vec2 Pos) const override
	{
		...
		This.Graphics()->QuadsBegin();
		This.Graphics()->SetColor(m_Color);
		This.Sprites()->SelectSprite(m_Sprite, m_SpriteFlags);
		This.Sprites()->DrawSprite(Pos.x, Pos.y, Size().x, Size().y);
		This.Graphics()->QuadsEnd();
		This.Graphics()->QuadsSetRotation(0.0f);
	}
};
