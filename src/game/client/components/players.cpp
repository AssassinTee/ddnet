	...
	float Intra)
{
	...
	{
		float LeftFriction = Material()->Get(LeftMat).m_GroundFriction;
		float RightFriction = Material()->Get(RightMat).m_GroundFriction;
		...
		CMatDefault &SkidMaterial = Material()->Get(SkidMaterialID);
