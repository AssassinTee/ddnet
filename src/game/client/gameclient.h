...
public:
	...
	// TODO: move this
	CTuneParams m_Tuning[NUM_DUMMIES];
	...
	CTuneParams &GetTunes(int i) { return m_aTuningList[i]; }
...
private:
	...
	CTuneParams m_aTuningList[NUM_TUNEZONES];
	CTuneParams *TuningList() { return m_aTuningList; }
