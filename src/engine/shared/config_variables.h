...
MACRO_CONFIG_INT(ClOverlayEntities, cl_overlay_entities, 0, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Only show entities")
MACRO_CONFIG_INT(ClOnlyEntities, cl_only_show_entities, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Only enable entity rendering. You can't turn this on or off without a map reload")
