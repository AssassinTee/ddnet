...
public:
	...
	*/
	...
	virtual void RenderTileLayerColor(int BufferContainerIndex, ColorRGBA *pColor, char **pOffsets, unsigned int *pIndicedVertexDrawNum, size_t NumIndicesOffset) = 0;
